  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-6 px-6 py-4 max-w-5xl mx-auto">
        ...
        {/* LOGO — vuelve al inicio (reload completo para resetear cualquier categoría seleccionada) */}
        <a href="/" aria-label="Ir al inicio MeliFut" className="shrink-0">
          <img
            src="/melifut-logo.jpg"
            alt="MELIFUT - Volver al inicio"
